...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        lemonImage?.setImageResource(R.drawable.select)
    ...
    private fun setViewElements() {
        ...
        if (lemonadeState == SQUEEZE) {
            lemonImage?.setImageResource(R.drawable.squeeze)
            textAction.text =  getString(R.string.lemon_squeeze)
        }
        else if(lemonadeState==DRINK) {
            lemonImage?.setImageResource(R.drawable.drink)
            textAction.text =  getString(R.string.lemon_drink)
        }
        else if(lemonadeState== RESTART) {
            lemonImage?.setImageResource(R.drawable.restart)
